<?php if (!@$_GET['form']): ?>
<form class="" id="form_sewa" action="#" method="post">
  <div class="col-md-12">
...
<?php else: ?>
  <div class="panel-header md-panel-controls">
    <h3><i class="fa fa-table"></i> <strong>Data </strong> sewa</h3>
  </div>
  <div class="panel-content pagination2 table-responsive">
    <table id="laporan_data_sewa" class="table table-bordered table-striped">
      <thead>
        <tr>
          <th>No.</th>
          <th>No Bukti</th>
